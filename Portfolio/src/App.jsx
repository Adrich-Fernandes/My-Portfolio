...
export default function GlassArctic() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full px-6 md:px-10 h-16 flex items-center">
          <div className="flex-1">
            <h1
              className="text-2xl md:text-3xl font-extrabold cursor-pointer tracking-tight"
              style={{ color: "#7dd3fc", textShadow: "0 0 20px rgba(125,211,252,0.5)" }}
            >
              ❄ Portfolio
            </h1>
          </div>
          ...
          <div className="hidden md:flex gap-3">
            {["home", "about", "projects", "skills", "experience"].map((item) => (
              <button
                ...
                onMouseEnter={e => e.target.style.background = "rgba(125,211,252,0.1)"}
      ...
      {/* Mobile Overlay */}
      {menuOpen && (
        <div onClick={() => setMenuOpen(false)} className="fixed inset-0 bg-black/60 z-40 backdrop-blur-sm" />
      )}
        ...
        <div className="flex flex-col p-6 gap-6">
          {["about", "projects", "skills", "experience", "contact"].map((item) => (
            <button
              key={item}
              onClick={() => handleScroll(item)}
              className="text-left text-lg text-[#bae6fd] capitalize hover:text-white transition"
            >
      ...
      <div id="home" className="relative z-10 min-h-screen flex flex-col md:flex-row items-center px-6 md:px-16 pt-28 gap-10">
        ...
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left order-2 md:order-1">
          <span
            className="inline-block px-4 py-1.5 rounded-full text-sm font-medium text-[#0c1a2e]"
            style={{ background: "linear-gradient(135deg, #38bdf8, #7dd3fc)", boxShadow: "0 0 15px rgba(56,189,248,0.4)" }}
          >
          ...
          <div className="text-4xl md:text-5xl font-extrabold leading-tight">
            ...
            <span style={{ color: "#38bdf8", textShadow: "0 0 30px rgba(56,189,248,0.6)" }}>
              Adrich Fernandes
            </span>
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <button
              ...
              style={{ border: "1px solid rgba(56,189,248,0.5)", color: "#38bdf8", background: "rgba(56,189,248,0.05)" }}
              onMouseEnter={e => { e.target.style.background = "rgba(56,189,248,0.15)"; e.target.style.boxShadow = "0 0 20px rgba(56,189,248,0.3)"; }}
              onMouseLeave={e => { e.target.style.background = "rgba(56,189,248,0.05)"; e.target.style.boxShadow = "none"; }}
            >
              View My Work
            </button>
            <button
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center order-1 md:order-2">
          <div
            ...
            style={{ background: "linear-gradient(135deg, #38bdf8, #7dd3fc, #bae6fd)", boxShadow: "0 0 60px rgba(56,189,248,0.4)" }}
          >
            <img
            ...
            <div
              ...
              style={{ border: "2px solid rgba(186,230,253,0.3)", boxShadow: "inset 0 0 30px rgba(56,189,248,0.1)" }}
            />
          </div>
        </div>
      </div>
      ...
      <div id="about" className="relative z-10 min-h-screen px-6 md:px-16 py-44">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold" style={{ color: "#7dd3fc", textShadow: "0 0 20px rgba(125,211,252,0.4)" }}>
            About Me
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            {
              img: "https://cdn3d.iconscout.com/3d/premium/thumb/code-3d-icon-png-download-5285090.png",
              title: "Clean Code",
              desc: "Writing maintainable, scalable code that follows best practices and industry standards",
            },
            {
              img: "https://static.vecteezy.com/system/resources/thumbnails/069/414/172/small/3d-lightning-bolt-icon-for-power-and-energy-png.png",
              title: "Performance",
              desc: "Optimizing applications for speed, efficiency, and exceptional user experience",
            },
            {
              img: "https://cdn3d.iconscout.com/3d/premium/thumb/ui-design-3d-icon-png-download-5846532.png",
              title: "UI Design",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[
            ...
            },
            {
              ...
              title: "Project Three",
              desc: "Backend-focused system with optimized APIs and scalable architecture.",
            },
          ].map((project, i) => (
            <div key={i} className={`${glassCard} hover:bg-white/10 hover:border-[#7dd3fc]/40 hover:shadow-[0_0_40px_rgba(125,211,252,0.2)] transition duration-500 hover:scale-105 overflow-hidden flex flex-col`}>
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <button
                  className="w-fit px-5 py-2 rounded-xl text-sm font-semibold text-[#0c1a2e] transition duration-300"
                  style={{ background: "linear-gradient(135deg, #38bdf8, #7dd3fc)", boxShadow: "0 0 15px rgba(56,189,248,0.3)" }}
                >
                  GitHub ↗
                </button>
              </div>
      ...
      <div id="skills" className="relative z-10 w-full py-28 px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <div key={i} className={`${glassCard} p-10 hover:border-[#7dd3fc]/40 hover:shadow-[0_0_40px_rgba(125,211,252,0.15)] transition duration-500`}>
              <h3 className="text-2xl font-bold mb-10 text-[#e0f2fe]">{category.title}</h3>
              {category.skills.map((skill, j) => (
                <div key={j} className="mb-6">
                  <div className="flex justify-between mb-2 text-[#93c5fd] text-sm">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
              <div
                ...
                style={{ border: "2px solid rgba(56,189,248,0.5)", boxShadow: "0 0 20px rgba(56,189,248,0.3)" }}
              >
                <img
              ...
              <span
                className="px-3 py-1 rounded-full text-xs font-semibold text-[#0c1a2e]"
            ...
            <div className="text-center">
              <span className="text-3xl font-bold" style={{ color: "#7dd3fc", textShadow: "0 0 20px rgba(125,211,252,0.5)" }}>
                MERN Stack
              </span>
            </div>
            ...
            <div className="flex flex-col gap-6 w-full md:w-auto">
              {[
                ...
                <div
                  ...
                  style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(125,211,252,0.1)" }}
                >
                  <div>
                  ...
                  <div className="flex justify-end">
                    <a
                      href="#"
                      className="px-4 py-2 text-sm font-semibold rounded-lg text-[#0c1a2e] transition duration-300"
                      style={{ background: "linear-gradient(135deg, #38bdf8, #7dd3fc)", boxShadow: "0 0 12px rgba(56,189,248,0.3)" }}
                    >
                      View Project ↗
                    </a>
                  </div>
      ...
      <div id="contact" className="relative z-10 w-full py-28 px-6 md:px-16">
        <div className="text-center mb-20">
          ...
          <p className="text-[#93c5fd] mt-4 text-lg">
